from langchain_intro.azureopenai import client as chat
...
from langchain_intro.azureopenai import embedding_function
...
#         Only answer healthcare-related questions.Otherwise Say I don't Knew"""
#     ),
#     HumanMessage(content="How to get a Engineering Degree?"),
# ]
...
# '|' unix pipe operator, which chains together the different componenets, 
# feeding output from one component as input into the next component
...
agent_chat_model=chat
hosptial_agent=create_openai_functions_agent(
